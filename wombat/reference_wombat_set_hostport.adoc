---
permalink: wombat/reference_wombat_set_hostport.html
sidebar: sidebar
keywords: 
...
[NOTE]
====
This command does not work in an iSCSI environment, where the host ports are considered initiators. Instead, use the `set iscsiInitiator` command. See xref:reference_wombat_set_iscsiinitiator.adoc[Set iSCSI initiator].
====
