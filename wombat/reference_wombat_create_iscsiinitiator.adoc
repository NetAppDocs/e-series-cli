---
permalink: wombat/reference_wombat_create_iscsiinitiator.html
sidebar: sidebar
keywords: 
...
[NOTE]
====
This command is deprecated and is replaced by the xref:reference_wombat_create_initiator.adoc[Create initiator] command.
====
