---
permalink: mongoose/reference_mongoose_array_configuration_commands.html
sidebar: sidebar
...
+
link:../wombat/reference_wombat_show_controller.md#[Show controller diagnostic status]
+
...
+
link:../wombat/reference_wombat_set_controller_iscsihostport.md#[Set iSCSI host port networking properties]
+
...
+
link:../wombat/reference_wombat_start_secureerase_drive.md#[Start secure drive erase]
+
xref:../wombat/reference_wombat_stop_drivechannel_faultdiagnostics.adoc[Stop drive channel fault isolation diagnostics]
+
...
+
link:../wombat/reference_wombat_activate_storagearray_firmware.md#[Activate storage array firmware]
+
...
+
link:../wombat/reference_wombat_set_storagearray_hostconnectivityreporting.md#[Enable or disable host connectivity reporting]
+
xref:../wombat/reference_wombat_enable_storagearray_feature_file.adoc[Enable storage array feature]
+
...
+
xref:../wombat/reference_wombat_recreate_storagearray_securitykey.adoc[Re-create external security key]
+
...
+
link:../wombat/reference_wombat_save_storage_array_diagnostic_data.md#[Save storage array diagnostic data]
+
...
+
link:../wombat/reference_wombat_set_storagearray_learncycledate_controller.md#[Set storage array learn cycle]
+
...
+
link:../wombat/reference_wombat_set_storagearray_securitykey.md#[Set storage array security key]
+
...
+
link:../wombat/reference_wombat_show_certificates.md#[Show certificates]
+
link:../wombat/reference_wombat_show_storagearray.md#[Show storage array]
+
...
+
xref:../wombat/reference_wombat_set_tray.adoc[Set tray attribute]
+
