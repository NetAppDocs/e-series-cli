---
permalink: mongoose/mongoose-security-commands.html
sidebar: sidebar
...
+
link:../wombat/wombat-save-auditlog.md#[Save audit log records]
+
...
+
link:../wombat/wombat-getting-started-with-aurthentication.md#[Getting started with authentication]
+
...
+
link:../wombat/wombat-delete-controller-cacertificate.md#[Remove installed signed certificate]
+
...
+
link:../wombat/wombat-start-storagearray-ocspresponderurl-test.md#[Start certificate revocation OCSP server test]
...
* *Database commands*
+
link:../wombat/wombat-clear-storagearray-configuration.md#[Clear storage array configuration]
+
link:../wombat/wombat-clear-storagearray-recoverymode.md#[Clear storage array recovery mode]
+
link:../wombat/wombat-load-storagearray-dbmdatabase.md#[Load storage array DBM database]
+
link:../wombat/wombat-save-storagearray-dbmdatabase.md#[Save storage array DBM database]
+
link:../wombat/wombat-save-storagearray-dbmvalidatorinfo.md#[Save storage array DBM validator information file]
+
link:../wombat/wombat-show-storagearray-dbmdatabase.md#[Show storage array DBM database]
+
link:../wombat/wombat-start-storagearray-configdbdiagnostic.md#[Start storage array configuration database diagnostic]
+
link:../wombat/wombat-stop-storagearray-configdbdiagnostic.md#[Stop storage array configuration diagnostic]

* *Embedded External Key Management commands*
+
xref:../wombat/wombat-set-storagearray-externalkeymanagement.adoc[Getting started with external key management]
+
link:../wombat/wombat-getting-started-with-internal-key-management.md#[Getting started with internal key management]
+
link:../wombat/wombat-create-storagearray-securitykey.md#[Create storage array security key]
+
link:../wombat/wombat-disable-storagearray-externalkeymanagement-file.md#[Disable external security key management]
+
link:../wombat/wombat-enable-storagearray-externalkeymanagement-file.md#[Enable external security key management]
+
link:../wombat/wombat-export-storagearray-securitykey.md#[Export storage array security key]
+
link:../wombat/wombat-import-storagearray-securitykey-file.md#[Import storage array security key]
+
xref:../wombat/wombat-set-storagearray-externalkeymanagement.adoc[Set FIPS drive security identifier]
+
xref:../wombat/wombat-set-storagearray-externalkeymanagement.adoc[Set external key management settings]
+
xref:../wombat/wombat-set-storagearray-externalkeymanagement.adoc[Set storage array security key]
+
...
+
link:../wombat/wombat-validate-storagearray-securitykey.md#[Validate storage array security key]

* *External Key Management commands related to certificates*
+
link:../wombat/wombat-save-storagearray-keymanagementclientcsr.md#[Retrieve installed key management CSR request]
+
