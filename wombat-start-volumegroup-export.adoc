---
permalink: wombat-start-volumegroup-export.html
sidebar: sidebar
keywords: 
...
[CAUTION]
====
Do not perform these steps without first performing the steps listed in xref:mongoose-learn-about-volume-group-migration.adoc[Learn about volume group migration.]
====
