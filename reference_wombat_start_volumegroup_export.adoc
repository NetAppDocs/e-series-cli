---
permalink: reference_wombat_start_volumegroup_export.html
sidebar: sidebar
keywords: 
...
[CAUTION]
====
Do not perform these steps without first performing the steps listed in xref:concept_mongoose_learn_about_volume_group_migration.adoc[Learn about volume group migration.]
====
