...
NOTE: The character limit for the standard and thin volumes names is 60 characters. The volume name can contain any combination of alphanumeric characters, underscore (_), hyphen (-), and pound (#).
...
You can use any combination of alphanumeric characters, underscore (_), hyphen (-), and pound (#) for the names. Standard and thin volumes names can have a maximum of 60 characters.
