...
---
= Set storage array to enable or disable cache mirror data assurance check - SANtricity CLI
:icons: font
:imagesdir: ../media/
...
This command applies to an individual E4000, E2800, E5700, EF600, EF300, EF50, or EF80 storage array. It does not operate on E2700 or E5600 storage arrays.
