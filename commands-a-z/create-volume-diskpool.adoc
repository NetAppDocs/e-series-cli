...
---
= Create volume in disk pool - SANtricity CLI
:icons: font
:imagesdir: ../media/
...
Each volume name must be unique. You can use any combination of alphanumeric characters, underscore (_), hyphen (-), and pound (#) for the user label. Standard and thin volumes names can have a maximum of 60 characters.
