...
Each volume name must be unique. You can use any combination of alphanumeric characters, underscore (_), hyphen (-), and pound (#) for the user label. Standard and thin volume names can have a maximum of 60 characters.
