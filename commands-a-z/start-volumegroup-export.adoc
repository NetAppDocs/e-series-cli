...
---
= Start volume group export - SANtricity CLI
:icons: font
:imagesdir: ../media/
...
[CAUTION]
====
Do not perform these steps without first performing the steps listed in xref:../get-started/learn-about-volume-group-migration.adoc[Learn about volume group migration.]
====
