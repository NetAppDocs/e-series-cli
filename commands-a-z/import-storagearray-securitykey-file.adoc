...
---
= Import storage array security key - SANtricity CLI
:icons: font
:imagesdir: ../media/
...
If external key management is enabled, then this command applies only to the E4000, E2800, E5700, EF600, EF300, EF50, or EF80 arrays. If internal key management is enabled, then the command applies to any individual storage array, as long as all SMcli packages are installed.
