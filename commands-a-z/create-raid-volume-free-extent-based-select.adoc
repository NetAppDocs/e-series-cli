...
NOTE: The character limit for the standard and thin volumes names name is 60 characters. The volume name can contain any combination of alphanumeric characters, underscore (_), hyphen (-), and pound (#).
