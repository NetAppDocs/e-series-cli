...
---
= Configure email alert settings - SANtricity CLI
:icons: font
:imagesdir: ../media/
...
This command applies to the E4000, E2800, E5700, EF600, EF300, EF50, and EF80 storage arrays. However, you can use the command as an SMcli command, not a script command, for E2700 or E5600 arrays. In this case, the command applies to all of the arrays in the management domain.
