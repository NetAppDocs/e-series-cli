...
---
= Set storage array PQ validation on reconstruct - SANtricity CLI
:icons: font
:imagesdir: ../media/
...
To execute this command on an E4000, 2800, E5700, EF600, EF300, EF50, or EF80 storage array, you must have the Storage Admin role.
