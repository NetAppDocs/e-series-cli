...
---
= Save storage array configuration - SANtricity CLI
:icons: font
:imagesdir: ../media/
...
To execute this command on an E4000, E2800, E5700, EF600, EF300, EF50, or EF80 storage array, you must have the Storage Admin role. However, the use of this command with the LDAP parameter is restricted to those with the Security Admin role.
