...
---
= Start volume group resource provisioning - SANtricity CLI
:icons: font
:imagesdir: ../media/
...
To execute this command on an EF600, EF300, EF50, and EF80 storage array, you must have the Storage Admin or Support Admin roles.
