...
You can use any combination of alphanumeric characters, hyphens, and underscores for the names. Standard and thin volumes names can have a maximum of 60 characters.
