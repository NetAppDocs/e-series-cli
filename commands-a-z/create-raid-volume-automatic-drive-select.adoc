...
---
= Create RAID volume (automatic drive select) - SANtricity CLI
:icons: font
:imagesdir: ../media/
...
NOTE: The character limit for standard and thin volumes names is 60 characters. The volume name can contain any combination of alphanumeric characters, underscore (_), hyphen (-), and pound (#).
...
You can use any combination of alphanumeric characters, hyphens, and underscores for the names. Standard and thin volume names can have a maximum of 60 characters; all other component names can have a maximum of 30 characters.
