...
---
= Create volume copy - SANtricity CLI
:icons: font
:imagesdir: ../media/
...
You can use any combination of alphanumeric characters, happens, and underscores for the names. Standard and thin volumes names can have a maximum of 60 characters.
