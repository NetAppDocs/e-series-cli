...
---
= Set read-only snapshot volume to read/write volume - SANtricity CLI
:icons: font
:imagesdir: ../media/
...
You can use any combination of alphanumeric characters, underscore (_), hyphen (-), and pound (#) for the user label. User labels can have a maximum of 60 characters.
