...
This command applies to an individual E4000, EF600 or EF300 storage array. It does not operate on E2700 or E5600 storage arrays.

== Roles

To execute this command on an E4000, EF600, or EF300 storage array, you must have the Security Admin role.
