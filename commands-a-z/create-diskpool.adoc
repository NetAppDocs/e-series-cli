...
---
= Create disk pool - SANtricity CLI
:icons: font
:imagesdir: ../media/
...
All slot ID maximums are 24. Slot ID values either begin at 0 or 1, depending on the tray model. Drive trays compatible with E2800, E5700, EF600, EF300, EF50, and EF80 controllers have slot ID numbers starting at 0. Drive trays compatible with E2700 and E5600 controllers have slot ID numbers starting at 1.
