...
---
= Set storage array resource provisioned volumes - SANtricity CLI
:icons: font
:imagesdir: ../media/
...
[NOTE]
====
You cannot set up mirroring on a volume while DULBE is enabled. To use mirroring, set the the `resourceProvisionedVolumes` to `disable`.
====
