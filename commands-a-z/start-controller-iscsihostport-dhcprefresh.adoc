...
[subs=+macros]
----
start controller [(a|b)] iscsiHostPort pass:quotes[[_portLabel_]] dhcpRefresh
----
...
link:ESERIES-SECTION_ID_ON_CONREFFED_SECTION.html[Identifying an iSCSI host port label]
