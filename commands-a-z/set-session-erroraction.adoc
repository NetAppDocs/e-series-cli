...
To execute this command on an E4000, E2800, E5700, EF600, EF300, EF50, or EF80 storage array, you must have the Storage Admin, Support Admin, Security Admin, or Storage Monitor role.
