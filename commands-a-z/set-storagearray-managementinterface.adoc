...
---
= Set storage array management interface - SANtricity CLI 
:icons: font
:imagesdir: ../media/
...
12.00 - This command is deprecated. Starting with SANtricity 12.00, the storage array will always operate in the `restOnly=true` mode.
