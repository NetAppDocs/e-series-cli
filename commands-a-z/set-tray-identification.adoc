...
---
= Set tray identification - SANtricity CLI
:icons: font
:imagesdir: ../media/
...
This command applies to any individual storage array, including the E2700, E5600, E2800, E5700, EF600, EF300, EF50, and EF80 arrays, as long as all SMcli packages are installed.
