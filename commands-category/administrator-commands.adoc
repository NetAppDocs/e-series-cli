...
---
= SANtricity CLI administrators commands
:icons: font
:imagesdir: ../media/

[.lead]
The following list of administrator commands are available for your E-Series storage system. 
...
link:../commands-a-z/create-snmpuser-username.html[Register SNMPv3 USM user]
...
link:../commands-a-z/show-storagearray-autosupport.html[Show AutoSupport configuration ]
...
link:../commands-a-z/show-allsnmpusers.html[Show SNMPv3 USM user]
...
link:../commands-a-z/delete-snmpuser-username.html[Unregister SNMPv3 USM user]

link:../commands-a-z/set-snmpcommunity.html[Update SNMP community]

link:../commands-a-z/set-snmpuser-username.html[Update SNMPv3 USM user]
