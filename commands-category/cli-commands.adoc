...
link:../commands-a-z/recreate-storagearray-securitykey.md#V879933[Re-create external security key]
...
link:../commands-a-z/save-storagearray-keymanagementcertificate.md#[Retrieve installed key management CSR request]
