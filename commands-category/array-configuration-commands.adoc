...
---
= SANtricity CLI array configuration commands
:icons: font
:imagesdir: ../media/
...
link:../commands-a-z/set-storagearray-host-io-protocol.html[Set storage array host I/O protocol]
...
link:../commands-a-z/show-storage-array-host-io-protocol.html[Show Storage Array Host I/O Protocol]
