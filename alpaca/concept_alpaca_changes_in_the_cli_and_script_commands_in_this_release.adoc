---
permalink: alpaca/concept_alpaca_changes_in_the_cli_and_script_commands_in_this_release.html
sidebar: sidebar
keywords: 
...
a|
xref:../wombat/reference_wombat_start_diskpool_resourceprovisioning.adoc[Start Disk Pool Resource Provisioning]
a|
Added command
a|
xref:../wombat/reference_wombat_start_volumegroup_resourceprovisioning.adoc[Start Volume Group Resource Provisioning]
a|
Added command
a|
...
| Command| Description of Change
a|
xref:../wombat/reference_wombat_create_snmpuser_username.adoc[Register SNMPv3 USM user]
a|
Added command
a|
xref:../wombat/reference_wombat_set_snmpuser_username.adoc[Update SNMPv3 USM user]
a|
Added command
a|
xref:../wombat/reference_wombat_show_allsnmpusers.adoc[Show SNMPv3 USM user]
a|
Added command
a|
xref:../wombat/reference_wombat_delete_snmpuser_username.adoc[Unregister SNMPv3 USM user]
a|
Added command
a|
...
| Command| Description of Change
a|
xref:../wombat/reference_wombat_start_drive_erase.adoc[Start drive erase]
a|
Added command
a|
...
a|
xref:../wombat/reference_wombat_add_certificate_from_array.adoc[Add certificate from array]
a|
Added command

a|
xref:../wombat/reference_wombat_add_certificate_from_file.adoc[Add certificate from file]
a|
Added command

a|
xref:../wombat/reference_wombat_delete_certificates.adoc[Delete certificates]
a|
Added command

a|
xref:../wombat/reference_wombat_show_certificates.adoc[Show certificates]
a|
Added command

a|
xref:../wombat/reference_wombat_add_array_label.adoc[Add array label]
a|
Added command

a|
xref:../wombat/reference_wombat_remove_array_label.adoc[Remove array label]
a|
Added command

a|
xref:../wombat/reference_wombat_show_array_label.adoc[Show array label]
a|
Added command
