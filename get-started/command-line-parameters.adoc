...
For a list of new, deprecated, and obsolete commands with this release, see xref:changes-in-the-cli-and-script-commands-in-this-release.adoc[Changes in the CLI and Script commands in this release].
