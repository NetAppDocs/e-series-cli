...
---
= Learn about SANtricity CLI naming conventions
:icons: font
:imagesdir: ../media/
...
* Standard and thin volumes names can have a maximum of 60 characters. All other component names can have a maximum of 30 characters.
