...
summary: "If you enter `SMcli` and a storage array name, but do not specify CLI parameters, script commands, or a script file, the command line interface runs in interactive mode."
---
= Interactive mode
:icons: font
:imagesdir: ./media/
